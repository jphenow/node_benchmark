...
CPPPATH_NODE = '/usr/local/Cellar/node/0.6.7/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-I/usr/local/mysql/include']
CXXFLAGS_DEBUG = ['-g']
...
LIBPATH_NODE = '/usr/local/Cellar/node/0.6.7/lib'
LIBPATH_ST = '-L%s'
LIB_MYSQLCLIENT_R = ['mysqlclient_r']
LIB_ST = '-l%s'
LINKFLAGS = ['-L/usr/local/mysql/lib', '-lmysqlclient_r', '-lpthread']
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
MYSQL_CONFIG = '/usr/local/mysql/bin/mysql_config'
NODE_PATH = '/usr/local/lib/node_modules:'
PREFIX = '/usr/local'
PREFIX_NODE = '/usr/local/Cellar/node/0.6.7'
